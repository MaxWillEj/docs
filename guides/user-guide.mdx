...
2. **Register OAuth Client**
   ...
   Make a POST request to register Claude as an OAuth client:

   ```bash
   curl -X POST https://...supabase.co/functions/v1/mcp-oauth-server/register \
...
**See the complete [OAuth Integration Guide](./OAUTH_INTEGRATION_GUIDE.md)**
...
```
https://nqfciqtsrcjorlqcglmq.supabase.co/functions/v1/mcp-router/[your-deployment-slug]
```
...
Tydli's documentation is available as an MCP server, allowing you to access help directly from Claude Desktop, ChatGPT, or any MCP-compatible client.
...
**Setup:**
1. Add the URL to your MCP client configuration
2. Ask questions naturally: "How do I set up OAuth in Tydli?"
3. Get instant answers from the official documentation

This is Tydli dogfooding itself - we use our own technology to make our documentation more accessible!
