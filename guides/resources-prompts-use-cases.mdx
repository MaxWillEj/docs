...
> 💡 **New to Resources & Prompts?** Read the [User Guide section](./USER_GUIDE.md#customizing-resources--prompts) first for fundamentals.
...
- [User Guide: Resources & Prompts](./USER_GUIDE.md#customizing-resources--prompts)
- [API Reference: MCP Endpoints](/api-reference/platform-api)
