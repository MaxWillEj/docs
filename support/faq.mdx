...
**Resources** let you provide curated data and documentation to AI agents - like API docs, configuration files, or reference materials. They are read-only data sources that AI agents can access via the `resources/read` method.

**Prompts** are reusable templates for common AI interactions. They support arguments for dynamic content and help AI agents work more effectively with your MCP server by providing structured interaction patterns.

Both Resources and Prompts can be configured in the MCP Customization Modal for each deployment, giving you full control over how AI agents interact with your server.
