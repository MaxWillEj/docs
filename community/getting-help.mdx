...
- **[Quickstart Guide](/quickstart)**: Deploy your first MCP server in 60 seconds
- **[Core Concepts](/core-concepts)**: Understand how MCP and Tydli work
- **[Claude Desktop Setup](/claude-desktop-setup)**: Connect your deployment to Claude
- **[Troubleshooting Guide](/troubleshooting)**: Comprehensive problem-solving guide
- **[Common Issues](/common-issues)**: Quick fixes for frequent problems
- **[FAQ](/faq)**: Frequently asked questions

### Learning Resources

- **[Real-World Use Cases](/use-cases)**: Get inspiration from successful implementations
- **[Best Practices](/best-practices)**: Production-ready deployment guidelines
- **[Authentication Methods](/authentication-methods)**: Secure your APIs
- **[Advanced Topics](/custom-mcp-development)**: Custom MCP development
...
1. Try the [Troubleshooting Guide](/troubleshooting) first
2. Check [Common Issues](/common-issues) for quick fixes
...
**New!** Tydli documentation is available as an MCP server:

https://docs.tydli.io/mcp


Add this to Claude Desktop, ChatGPT, or any MCP-compatible client to:
- Ask questions about Tydli directly in your AI chat
- Get instant answers from official documentation
- Access help without leaving your workflow

**Example queries:**
- "How do I configure OAuth in Tydli?"
- "What authentication methods does Tydli support?"
- "Show me the quickstart guide"
- "How do I troubleshoot deployment issues?"

The documentation comes to you - no browser tab required!
