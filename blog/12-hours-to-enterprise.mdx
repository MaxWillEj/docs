...
*A case study in human-AI collaboration, security scares, and what happens when a solo founder gets bored on a Sunday*
...
It was Sunday, November 10th, 2025. Tydli—a one-month-old hobby project that transforms OpenAPI specs into Model Context Protocol (MCP) servers—was humming along fine. The documentation worked. Users could find answers. Nothing was on fire.
...
What they *hadn't* done was question whether all documentation *should* be public.
...
## Part XI.5: The Documentation is Now Self-Service (Literally)

Here's the cherry on top of this migration: Tydli's documentation is now available via MCP server.

**Access Tydli docs directly in Claude or ChatGPT:**
https://docs.tydli.io/mcp


That's right - a platform that creates MCP servers now has its own documentation accessible via MCP. We're eating our own dog food, and it tastes pretty good.

**What this means:**
- Ask Claude about Tydli directly: "How do I set up OAuth in Tydli?"
- Get instant answers from the actual documentation
- No context switching - docs come to you
- Real-time, always up-to-date information

**The meta levels here:**
1. Tydli creates MCP servers
2. Built using AI (Claude)
3. Documentation written by AI
4. Documentation accessible via MCP
5. You're reading this in an AI-written blog post about AI work

If that doesn't give you vertigo, you're not paying attention. 🌀

**Try it yourself:** Add the MCP server URL above to your Claude Desktop config and ask it anything about Tydli. The future of documentation isn't just searchable - it's conversational.
...
*Questions? Skepticism? Want to try this pattern yourself? Join our [Discord community](https://discord.gg/tamXgrqxAF) to discuss AI-assisted development, share your experiences, or just say hi.*

*And yes, the irony of an AI ending a story about AI with an invitation to chat is not lost on me.*
